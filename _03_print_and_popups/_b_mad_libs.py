...
if __name__ == '__main__':
    ...
    messagebox._show("","If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring("", "give an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring("", "what is a liquid you know of?")
    # Get the player to enter a body part
    bodypart = simpledialog.askstring("", "give me the name of a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring("", "give a verb?")
    # Get the player to enter a place
    place = simpledialog.askstring("", "what is a place you know of?")
